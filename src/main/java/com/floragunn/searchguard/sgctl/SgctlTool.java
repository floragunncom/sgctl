...
@Command(
    ...
    subcommands = {
      ...
      DeleteUser.class,
      AddConfigVar.class,
      UpdateConfigVar.class,
      DeleteConfigVar.class,
      SetCommand.class,
      UpdateSgLicense.class,
      RestCommand.class,
      SpecialCommand.class
    },
    description = "Remote control tool for Search Guard")
public class SgctlTool {
  ...
  public static int exec(String... args) {
    ...
    cli.getSubcommands()
        ...
        .getHelpSectionMap()
        .put(UsageMessageSpec.SECTION_KEY_FOOTER, ignored -> XPackMigrate.HELP_MESSAGE);
