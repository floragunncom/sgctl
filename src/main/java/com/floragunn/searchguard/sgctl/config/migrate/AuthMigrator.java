...
import com.floragunn.searchguard.sgctl.config.searchguard.SgAuthC.AuthDomain.Ldap.Filter;
import com.floragunn.searchguard.sgctl.config.searchguard.SgAuthC.AuthDomain.Ldap.GroupSearch;
import com.floragunn.searchguard.sgctl.config.searchguard.SgAuthC.AuthDomain.Ldap.IdentityProvider;
import com.floragunn.searchguard.sgctl.config.searchguard.SgAuthC.AuthDomain.Ldap.SearchScope;
import com.floragunn.searchguard.sgctl.config.searchguard.SgAuthC.AuthDomain.Ldap.UserSearch;
...
public class AuthMigrator implements SubMigrator {
  ...
  public List<NamedConfig<?>> migrate(
    ...
    for (var realm : sortedRealms) {
      ...
      if (!realm.get().enabled().get()) continue;
