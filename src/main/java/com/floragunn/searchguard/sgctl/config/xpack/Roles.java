...
public record Roles(
    ImmutableMap<String, Role> roles
) {
    ...
    public record Role(
        ...
        public static Role parse(DocNode node, Parser.Context context) throws ConfigValidationException {
            ...
            Role role = new Role(
                    ...
                    node.containsKey("cluster") ? v.get("cluster").asList().ofStrings() : ImmutableList.empty(),
                    Optional.ofNullable(node.containsKey("global") ? v.get("global").asDocNode() : null),

                    // Parsed by other functions
                    node.containsKey("indices") ? v.get("indices").asList().ofObjectsParsedBy(Index::parse) : ImmutableList.empty(),
                    node.containsKey("applications") ? v.get("applications").asList().ofObjectsParsedBy(Application::parse) : ImmutableList.empty(),
                    v.get("remote_indices").asList().withEmptyListAsDefault().ofObjectsParsedBy(RemoteIndex::parse),
                    v.get("remote_cluster").asList().withEmptyListAsDefault().ofObjectsParsedBy(RemoteCluster::parse),

                    // Metadata is required
                    node.containsKey("metadata") ? v.get("metadata").asMap() : ImmutableMap.empty(),

                    // Is Optional, becomes an empty map if missing
                    node.containsKey("transient_metadata") ? v.get("transient_metadata").asMap() : ImmutableMap.empty(),
                    Optional.ofNullable(node.containsKey("description") ? v.get("description").asString() : null)
    ...
    public record Index(
        ...
        public static Index parse(DocNode node, Parser.Context context) throws ConfigValidationException {
            ValidationErrors errors = new ValidationErrors();
            ValidatingDocNode v = new ValidatingDocNode(node, errors, context);
            ...
            Index index = new Index(
                node.containsKey("names") ? v.get("names").asList().ofStrings() : ImmutableList.empty(),
                node.containsKey("privileges") ? v.get("privileges").asList().ofStrings() : ImmutableList.empty(),
                Optional.ofNullable(node.containsKey("field_security") ? v.get("field_security").asDocNode() : null),
                Optional.ofNullable(node.containsKey("query") ? v.get("query").asString() : null),
                node.containsKey("allow_restricted_indices") ? v.get("allow_restricted_indices").asBoolean() : false
            );
            v.throwExceptionForPresentErrors();
            return index;
        }
    ...
    public record RemoteIndex(
        ...
        public static RemoteIndex parse(DocNode node, Parser.Context context) throws ConfigValidationException {
            ValidationErrors errors = new ValidationErrors();
            ValidatingDocNode v = new ValidatingDocNode(node, errors, context);
            ...
            RemoteIndex remoteindex = new RemoteIndex(
                    node.containsKey("clusters") ? v.get("clusters").asList().ofStrings() : ImmutableList.empty(),
                    node.containsKey("names") ? v.get("names").asList().ofStrings() : ImmutableList.empty(),
                    node.containsKey("privileges") ? v.get("privileges").asList().ofStrings() : ImmutableList.empty(),
                    Optional.ofNullable(node.containsKey("field_security") ? v.get("field_security").asDocNode() : null),
                    Optional.ofNullable(node.containsKey("query") ? v.get("query").asString() : null),
    ...
    public record Application(
        ...
        public static Application parse(DocNode node, Parser.Context context) throws ConfigValidationException {
            ValidationErrors errors = new ValidationErrors();
            ValidatingDocNode v = new ValidatingDocNode(node, errors, context);
            ...
            Application application = new Application(
                    ...
                    node.containsKey("privileges") ? v.get("privileges").asList().ofStrings() : ImmutableList.empty(),
                    node.containsKey("resources") ? v.get("resources").asList().ofStrings() : ImmutableList.empty()
            );
            v.throwExceptionForPresentErrors();
            return application;
        }
    ...
    public record RemoteCluster(
        ...
        public static RemoteCluster parse(DocNode node, Parser.Context context) throws ConfigValidationException {
            ValidationErrors errors = new ValidationErrors();
            ValidatingDocNode v = new ValidatingDocNode(node, errors, context);

            RemoteCluster remoteCluster = new RemoteCluster(
