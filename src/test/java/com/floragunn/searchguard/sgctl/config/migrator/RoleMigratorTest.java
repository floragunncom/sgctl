...
public class RoleMigratorTest {
  ...
  //todo index & cluster privileges
  //todo check logger for unmigratable privileges
  //todo logger for index & cluster privileges
  //todo check for logger warning of empty roles file
  //todo check for logger warning of empty Alias action group
  //todo check for logger warning of empty Datastream action group
  //todo check for logger warning of empty Tenant action group
  @Test
  public void testMigration() throws IOException, SgctlException {
    ...
    verify(logger, atLeastOnce()).warn("Could not migrate index privilege typocorection for role test_role2");
