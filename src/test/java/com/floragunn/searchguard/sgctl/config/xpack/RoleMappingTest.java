...
public class RoleMappingTest {
    ...
    public void testParseSimple() throws IOException, ConfigValidationException {
        ...
        assertEquals(
            new RoleMappings(ImmutableMap.of(
                "admins",
                new Roles(
                    true,
        ...
        assertEquals(
            new RoleMappings(ImmutableMap.of(
                ...
                new Roles(
                    ...
                    new Any(ImmutableList.of(
                        new Field(jsonNode("{\"dn\": \"cn=John Doe,cn=contractors,dc=example,dc=com\"}")),
    ...
    public void testInvalidTooManyRules() throws IOException, DocumentParseException {
        ...
        assertThrows(ConfigValidationException.class, () -> RoleMappings.parse(node, Parser.Context.get()));
    }
